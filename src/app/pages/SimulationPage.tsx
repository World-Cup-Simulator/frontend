    ...
    <div className="flex flex-col pt-16 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-6 flex flex-col gap-6">
        ...
        <div className="flex justify-center">
          <button
            type="button"
            className="px-6 py-2 md:px-8 md:py-3 text-sm md:text-base font-medium rounded-xl transition-all duration-200 ease-out shadow-lg bg-indigo-600 hover:bg-indigo-500 text-white cursor-pointer"
